...
const GlobalStyles = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .vol-input:focus { border-color: #FFE338 !important; box-shadow: 0 0 0 1px rgba(168,85,247,0.5), 0 0 20px rgba(168,85,247,0.2) !important; outline: none !important; }
    ...
    <div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none", zIndex: 1 }}>
      {particles.current.map((p, i) => (
        <div key={i} style={{
          ...
          background: "#FFF275", filter: "blur(1px)",
    ...
    <div ref={ref} style={{ textAlign: "center" }}>
      <motion.div
        ...
        style={{
          ...
          lineHeight: 1,
          background: "linear-gradient(135deg, #fff 30%, #FFF275 100%)",
      ...
      <div style={{
        ...
        {!done && (
          <span style={{
            ...
            background: "#FFF275", marginLeft: 4, verticalAlign: "middle",
  ...
  return (
    <div className="vol-page">
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div style={{ fontSize: "0.7rem", color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: "0.12em" }}>
            ...
            <span style={{ color: "#FFF275" }}>Community</span>
          </div>
        </div>
        <motion.button
          onClick={scrollToApply}
          whileHover={{ scale: 1.03, backgroundColor: "#E5A93C" }}
          whileTap={{ scale: 0.97 }}
          style={{
      ...
      <section style={{ position: "relative", height: "100vh", overflow: "hidden", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
        ...
        >
          ...
          <motion.div
            ...
            style={{
              fontSize: "0.72rem", letterSpacing: "0.45em", color: "#FFF275",
              textTransform: "uppercase", fontFamily: "monospace", marginBottom: 32,
              display: "flex", alignItems: "center", justifyContent: "center", gap: 16,
            }}
          >
            <span style={{ display: "inline-block", width: 40, height: 1, background: "rgba(255, 242, 117,0.5)" }} />
          ...
          <div style={{ overflow: "hidden" }}>
            ...
            >
              NOT EVERYONE<br />
              <span style={{ color: "#fff", WebkitTextStroke: "1px rgba(255, 242, 117,0.6)", WebkitTextFillColor: "transparent" }}>JUST ARRIVES.</span>
            </motion.h1>
          </div>
          ...
          <motion.div
            ...
            style={{
              ...
              letterSpacing: "0.06em", color: "#FFF275",
              margin: "8px 0 32px",
            }}
          >
        ...
        >
          ...
          <motion.div
            ...
            style={{ width: 1, height: 40, background: "linear-gradient(to bottom, rgba(255, 242, 117,0.6), transparent)" }}
          />
        </motion.div>
      </section>
      ...
      <section style={{ padding: "160px 5vw", position: "relative", overflow: "hidden" }}>
        ...
        >
          ...
          >
            ...
            >
              <div style={{ fontFamily: "'Instrument Serif', sans-serif", fontSize: "2.4rem", color: "#FFF275", lineHeight: 1 }}>3+</div>
          ...
          <motion.div
            ...
            transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
          >
            <div style={{ fontSize: "0.72rem", letterSpacing: "0.35em", color: "#FFF275", textTransform: "uppercase", marginBottom: 24, fontFamily: "monospace" }}>
              The Manifesto
            </div>
            <blockquote style={{
              fontFamily: "'Cormorant Garamond', serif",
      ...
      <section style={{ padding: "160px 0", background: "#0A0A0A" }}>
        ...
        >
          <div style={{ fontSize: "0.72rem", letterSpacing: "0.4em", color: "#FFF275", textTransform: "uppercase", fontFamily: "monospace", marginBottom: 20 }}>
            Exclusive Access
          </div>
          <h2 style={{
            fontFamily: "'Instrument Serif', sans-serif",
              ...
              return (
                ...
                >
                  <span style={{
                    ...
                    {isAccent && (
                      <span style={{ color: "#FFF275", marginRight: 16 }}>—</span>
                    )}
                    {line}
                  </span>
                </motion.div>
        ...
        <div style={{ position: "relative", zIndex: 2, textAlign: "center", padding: "0 5vw" }}>
          ...
          >
            <h2 style={{
              ...
              SEE YOU<br />
              <span style={{ WebkitTextStroke: "1px rgba(255, 242, 117,0.6)", WebkitTextFillColor: "transparent" }}>
                INSIDE.
              </span>
            </h2>
          </motion.div>
          ...
          <motion.button
            ...
            style={{
              padding: "20px 56px",
              background: "linear-gradient(135deg, #F26D4F, #E5A93C)",
