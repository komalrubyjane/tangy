          ...
          <GlassCard style={{ padding: "40px 36px", border: "1px solid rgba(124,58,237,0.35)", boxShadow: "0 25px 60px rgba(0,0,0,0.7), 0 0 50px rgba(124,58,237,0.12)" }}>
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <input
                ...
                onBlur={e => { e.target.style.borderColor = errors.name ? "#ef4444" : "rgba(124,58,237,0.25)"; e.target.style.boxShadow = "none"; }}
              />
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <input
                ...
                onFocus={e => { e.target.style.borderColor = "#7c3aed"; e.target.style.boxShadow = "0 0 0 3px rgba(124,58,237,0.12)"; }}
                onBlur={e => { e.target.style.borderColor = errors.email ? "#ef4444" : "rgba(124,58,237,0.25)"; e.target.style.boxShadow = "none"; }}
              />
            ...
            {/* Phone */}
            <div style={{ marginBottom: 18 }}>
              <label style={{ display: "block", fontSize: "0.65rem", letterSpacing: "0.2em", color: "rgba(255,255,255,0.45)", textTransform: "uppercase", marginBottom: 8 }}>Phone Number</label>
              <input
                id="booking-phone"
                type="tel"
            ...
            <div style={{ marginBottom: 24 }}>
              <label style={{ display: "block", fontSize: "0.65rem", letterSpacing: "0.2em", color: "rgba(255,255,255,0.45)", textTransform: "uppercase", marginBottom: 8 }}>Ticket Quantity (max 10)</label>
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                ...
                >−</button>
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2.2rem", color: "#fff", minWidth: 36, textAlign: "center", lineHeight: 1 }}>
                  {form.qty}
                </div>
                <button
                  id="qty-increase"
                  ...
                  onMouseLeave={e => { e.target.style.background = "rgba(124,58,237,0.12)"; }}
                >+</button>
                <div style={{ fontSize: "0.8rem", color: "rgba(255,255,255,0.35)", marginLeft: 4 }}>
                  × ₹{ev.price.toLocaleString()}
                </div>
              </div>
              {errors.qty && <div style={{ color: "#ef4444", fontSize: "0.72rem", marginTop: 6 }}>⚠ {errors.qty}</div>}
            </div>
