        ...
        >
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 18 }}>
            {ev.tags.map(tag => (
              <span key={tag} style={{
                ...
                color: "#F0E68C", letterSpacing: "0.1em", textTransform: "uppercase",
              }}>
                {tag}
              </span>
            ))}
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 32, marginBottom: 32 }}>
            ...
            <motion.button
              ...
              style={{
                padding: "14px 36px",
                background: "linear-gradient(135deg, #F26D4F 0%, #B8860B 100%)",
                border: "none",
                borderRadius: 30,
                color: "#fff",
                fontSize: "0.88rem",
          ...
          {submitSuccess ? (
            <GlassCard style={{ padding: "40px 32px", textAlign: "center", border: "1px solid rgba(16, 185, 129, 0.4)", boxShadow: "0 25px 60px rgba(0,0,0,0.7), 0 0 50px rgba(16, 185, 129, 0.15)" }}>
              ...
              <div style={{
                ...
                <div style={{ position: "absolute", top: 0, right: 0, width: 120, height: 120, background: "radial-gradient(circle, rgba(212, 175, 55, 0.1) 0%, transparent 75%)", pointerEvents: "none" }} />
                ...
                <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px dashed rgba(255,255,255,0.1)", paddingBottom: 14, marginBottom: 14 }}>
                  <div>
                    <div style={{ fontSize: "0.62rem", letterSpacing: "0.2em", color: "#D4AF37", textTransform: "uppercase", fontWeight: 700 }}>Tangy Sessions Entry Pass</div>
          ...
          <GlassCard style={{ padding: "40px 36px", border: "1px solid rgba(242, 109, 79,0.35)", boxShadow: "0 25px 60px rgba(0,0,0,0.7), 0 0 50px rgba(242, 109, 79,0.12)" }}>
            ...
            {/* Total price display */}            <div style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                ...
                <motion.span
                  key={total}
                  initial={{ scale: 1.2, color: "#F0E68C" }}
            ...
            <div style={{ background: "rgba(242, 109, 79,0.05)", border: "1px solid rgba(242, 109, 79,0.2)", borderRadius: 12, padding: "24px 20px", marginBottom: 26 }}>
              <h4 style={{ fontFamily: "'Instrument Serif', sans-serif", fontSize: "1.4rem", color: "#F0E68C", margin: "0 0 16px", letterSpacing: "0.05em" }}>Payment Details</h4>
            ...
            <motion.button
              ...
              whileHover={!isSubmitting ? { scale: 1.02, backgroundColor: "#B8860B" } : {}}
