...
const INITIAL_ARTISTS = [
  { id: 1, name: 'KALI', genre: 'Techno / Dark Ambient', bio: 'Sonic architect from Hyderabad weaving dark rituals in sound.', status: 'available', color: '#C8FF2B', tags: ['Techno', 'Ambient'], avatar: '/artists/artist1.jpg', appStatus: 'approved' },
  { id: 2, name: 'Zephyr Rao', genre: 'Deep House / Afrobeat', bio: 'Blending Carnatic roots with underground club culture.', status: 'booked', color: '#C8FF2B', tags: ['House', 'Afrobeat'], avatar: '/artists/artist2.jpg', appStatus: 'approved' },
