      ...
      {steps.map((s, i) => (
        <React.Fragment key={s}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
            <motion.div
              animate={{
                background: i < step ? "#C8FF2B" : i === step ? "rgba(200, 255, 43, 0.15)" : "rgba(255,255,255,0.05)",
              ...
              style={{
                ...
                fontSize: "0.75rem", fontWeight: 700, color: i < step ? "#080808" : i === step ? "#C8FF2B" : "rgba(255,255,255,0.3)",
                fontFamily: "'Space Mono', monospace",
              }}
            >
              {i < step ? "✓" : i + 1}
            </motion.div>
            <span style={{ fontSize: "0.6rem", letterSpacing: "0.2em", color: i <= step ? "#C8FF2B" : "rgba(255,255,255,0.25)", textTransform: "uppercase", fontFamily: "'Space Mono', monospace" }}>{s}</span>
          </div>
          {i < steps.length - 1 && (
            <motion.div
              ...
              <motion.div key="processing" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                ...
                <div style={{ marginTop: 24, height: 2, background: "rgba(255,255,255,0.06)", borderRadius: 2, overflow: "hidden" }}>
                  <motion.div
                    ...
                    style={{ height: "100%", background: "linear-gradient(to right, #C8FF2B, #C9A24B)", borderRadius: 2 }}
                  />
                </div>
              </motion.div>
            )}
