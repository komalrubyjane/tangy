  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: "linear-gradient(135deg, #111 0%, #111111 100%)",
      ...
      >
        {title && (
          <h3 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.8rem", letterSpacing: "0.05em", color: "var(--tangy-cream, #fff)", marginBottom: "12px", display: "flex", alignItems: "center", gap: "10px" }}>
            {type === 'confirm' ? <span style={{ color: '#f59e0b' }}>⚠️</span> : <span style={{ color: '#C8FF2B' }}>✦</span>}
            {title}
          </h3>
        )}
        ...
        <div style={{ display: "flex", gap: "12px", justifyContent: "flex-end" }}>
          ...
          <button
            ...
            style={{
              padding: "10px 24px", background: "#C8FF2B",
            ...
            onMouseEnter={(e) => { e.target.style.background = "#C8FF2B"; e.target.style.transform = "translateY(-1px)"; }}
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background: "#111", border: "1px solid #C8FF2B",
