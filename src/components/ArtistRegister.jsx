  ...
  return (
    <section id="artist-register" style={{ background: "transparent", padding: "clamp(120px, 14vw, 200px) 5vw", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        width: "55vw",
        height: "55vh",
        background: "radial-gradient(circle, rgba(255, 223, 0, 0.05) 0%, transparent 70%)",
        filter: "blur(90px)",
        zIndex: 0,
        pointerEvents: "none",
      }} />
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 0.8fr", gap: "6vw", alignItems: "center" }} className="artist-spotlight-grid">
          ...
          >
            <div style={{ fontSize: "0.72rem", letterSpacing: "0.3em", color: "#FFDF00", textTransform: "uppercase", fontFamily: "monospace", fontWeight: "700" }}>
            ...
            <div style={{ height: 2, width: 48, background: "linear-gradient(to right, #FFDF00, #06b6d4)", borderRadius: 1 }} />
