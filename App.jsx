...
const ARTISTS = [
  ...
  { id: 3, name: "SONDER",   role: "Live Electronic",     img: "/artists/artist3.jpg", color: "#F9E0A2", bio: "Live modular synthesis meets rhythm machines — every performance built entirely from patch cables and analog hardware. No presets. No laptops. Pure human emotion.",        genre: "Live Modular / Experimental", location: "New Delhi, India",  followers: "31.0K", performances: "165+" },
...
function Navbar() {
  ...
  return (
    <nav style={{
      ...
      borderBottom: scrolled ? "1px solid rgba(229, 192, 123,0.15)" : "none",
      ...
      <div style={{ display: "flex", gap: 28 }} className="nav-links">
        {links.map(l => (
          <button key={l} onClick={() => scrollTo(l)}
            ...
            onMouseEnter={e => { e.target.style.color = "#E5C07B"; e.target.style.transform = "translateY(-1px)"; }}
    ...
    <section ref={sectionRef} id="home" style={{ position: "relative", height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", background: "#050505" }}>
      ...
      <motion.div
        ...
        style={{
          ...
          width: "80vw",
          height: "60vh",
          background: "radial-gradient(circle, rgba(229, 192, 123,0.12) 0%, rgba(229, 192, 123,0.03) 50%, transparent 80%)",
          filter: "blur(100px)",
          zIndex: 3,
          pointerEvents: "none",
        }}
      ...
      <div style={{ position: "relative", zIndex: 4, textAlign: "center", padding: "0 24px", maxWidth: 800, margin: "0 auto" }}>
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.0, ease: "easeOut" }}
          style={{ fontSize: "clamp(0.65rem, 1.4vw, 0.85rem)", letterSpacing: "0.55em", color: "#E5C07B", textTransform: "uppercase", marginBottom: 24, fontFamily: "monospace" }}>
          Est. 2025 · Hyderabad
        </motion.div>
        ...
        >
          <motion.h1
            ...
            style={{
              ...
              color: "#fff",
              margin: 0,
              textShadow: "0 0 100px rgba(229, 192, 123,0.2)",
            }}
          >
            TANGY<br />
            <span style={{
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55, duration: 1.0, ease: "easeOut" }}
          ...
          <MagneticButton
            ...
            style={{
              padding: "15px 40px", background: "#E5C07B", color: "#fff", border: "none",
              ...
              boxShadow: "0 0 30px rgba(229, 192, 123,0.35)", transition: "background-color 0.3s ease",
            }}
          >
            Explore Events
          </MagneticButton>
          <MagneticButton
            ...
            onMouseEnter={e => { e.currentTarget.style.borderColor = "#F7E7C4"; e.currentTarget.style.color = "#F7E7C4"; }}
      ...
      <motion.div animate={{ y: [0, 8, 0] }} transition={{ repeat: Infinity, duration: 2.5 }}
        ...
        onClick={() => document.getElementById("events")?.scrollIntoView({ behavior: "smooth" })}>
        <div style={{ width: 1, height: 48, background: "linear-gradient(to bottom, transparent, #E5C07B)" }} />
        <div style={{ fontSize: "0.6rem", letterSpacing: "0.3em", color: "#E5C07B", textTransform: "uppercase" }}>Scroll</div>
      </motion.div>
    </section>
  );
}
            ...
            <React.Fragment key={idx}>
              ...
              >
                ...
                <span style={{
                  ...
                  letterSpacing: "0.04em",
                  lineHeight: 1,
                  textShadow: isHov ? "0 0 20px rgba(229, 192, 123,0.55)" : "none",
    ...
    <section id="why-tangy" style={{ background: "transparent", padding: "clamp(140px, 15vw, 220px) 5vw", position: "relative", overflow: "hidden" }}>
      ...
      <div
        style={{
          ...
          width: "60vw",
          height: "60vh",
          background: "radial-gradient(circle, rgba(229, 192, 123,0.06) 0%, transparent 70%)",
          filter: "blur(80px)",
          zIndex: 0,
          pointerEvents: "none",
        }}
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          <div style={{ fontSize: "0.72rem", letterSpacing: "0.4em", color: "#E5C07B", textTransform: "uppercase", fontFamily: "monospace", marginBottom: 14, fontWeight: "600" }}>
            Our Philosophy
          </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            style={{ height: 2, background: "linear-gradient(to right, #E5C07B, #F9E0A2)", marginTop: 18, borderRadius: 2 }}
          />
        </motion.div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 12 }}>
              {[
                ...
                <div key={idx} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                  <span style={{ color: "#E5C07B", fontSize: "1.2rem", lineHeight: 1.1 }}>✦</span>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 32, marginTop: 88, width: "100%" }}>
          {[
            ...
            <motion.div
              key={val.title}
              whileHover={{ y: -6, borderColor: "rgba(229, 192, 123, 0.3)", boxShadow: "0 20px 40px rgba(0,0,0,0.7)" }}
            ...
            >
              ...
              <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: "#E5C07B" }} />

              <div style={{ fontSize: "0.72rem", color: "#E5C07B", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 12, fontFamily: "monospace", fontWeight: "600" }}>
                0{idx + 1} // Value
              </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 32, marginTop: 88, width: "100%", borderTop: "1px solid rgba(255,255,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.06)", padding: "48px 0" }}>
          {[
            ...
            >
              <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "3.5rem", color: "#E5C07B", lineHeight: 1 }}>
                {stat.endStr === null
...
function EventCard({ ev, delay }) {
  ...
  return (
    <motion.div
      ...
      style={{
        background: hovered
          ? "linear-gradient(135deg, rgba(8,8,12,0.95) 0%, rgba(229, 192, 123,0.08) 100%)"
          : "linear-gradient(135deg, rgba(8,8,12,0.92) 0%, rgba(8,8,12,0.75) 100%)",
        backdropFilter: "blur(12px)",
        WebkitBackdropFilter: "blur(12px)",
        border: `1px solid ${hovered ? "rgba(229, 192, 123,0.40)" : "rgba(255,255,255,0.08)"}`,
        borderRadius: 24, padding: 32, cursor: "pointer",
        boxShadow: hovered
          ? "0 24px 60px rgba(0,0,0,0.75), 0 0 40px rgba(229, 192, 123,0.18), inset 0 1px 0 rgba(255,255,255,0.07)"
          : "0 12px 32px rgba(0,0,0,0.6), 0 0 20px rgba(229, 192, 123,0.06), inset 0 1px 0 rgba(255,255,255,0.04)",
        transform: hovered ? "translateY(-5px)" : "translateY(0)",
        transition: "all 0.35s cubic-bezier(0.16,1,0.3,1)",
        display: "flex", flexDirection: "column", gap: 0,
      }}>
      {/* Date + time */}
      <div style={{ fontSize: "0.68rem", letterSpacing: "0.25em", color: "#E5C07B", textTransform: "uppercase", fontFamily: "monospace", marginBottom: 14 }}>
        {ev.date} · {ev.time}
      </div>
      {/* Title */}
      ...
      <div style={{ marginBottom: 22 }}>
        ...
        <div style={{ height: 2, background: "rgba(255,255,255,0.06)", borderRadius: 2 }}>
          <motion.div initial={{ width: 0 }} whileInView={{ width: "60%" }} transition={{ duration: 0.8, delay: 0.3 }}
            style={{ height: "100%", borderRadius: 2, background: "linear-gradient(to right, #E5C07B, #06b6d4)" }} />
        </div>
      </div>
      {/* Price + CTA */}
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <motion.button
          ...
          onMouseEnter={e => { e.currentTarget.style.background = "rgba(229, 192, 123,0.18)"; e.currentTarget.style.borderColor = "#E5C07B"; e.currentTarget.style.color = "#fff"; }}
          onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.borderColor = "rgba(229, 192, 123,0.55)"; e.currentTarget.style.color = "#F3E5AB"; }}
        >
          View Details →
        </motion.button>
      </div>
        ...
        <div style={{
          ...
          <div style={{ position: "relative", width: "100%" }}>
            ...
            <input
              ...
              onFocus={e => { e.target.style.borderColor = "#E5C07B"; e.target.style.boxShadow = "0 0 20px rgba(229, 192, 123,0.2)"; }}
              onBlur={e => { e.target.style.borderColor = "rgba(229, 192, 123,0.18)"; e.target.style.boxShadow = "none"; }}
            />
            {search && (
              <button
                onClick={() => setSearch("")}
            ...
            {GENRES.map((g) => {
              ...
              return (
                <button
                  ...
                  style={{
                    padding: "8px 18px",
                    background: active ? "linear-gradient(135deg,#E5C07B,#F9E0A2)" : "rgba(255,255,255,0.03)",
                    border: `1px solid ${active ? "#F9E0A2" : "rgba(255,255,255,0.08)"}`,
                    borderRadius: 20, color: active ? "#fff" : "rgba(255,255,255,0.6)",
                    fontSize: "0.75rem", fontWeight: 600,
                    fontFamily: "inherit", cursor: "pointer",
                    letterSpacing: "0.05em",
                    transition: "all 0.3s cubic-bezier(0.16,1,0.3,1)",
                    boxShadow: active ? "0 8px 20px rgba(229, 192, 123,0.3)" : "none",
                  }}
                >{g}</button>
              );
            })}
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                border: "1px solid #E5C07B", borderRadius: 20,
              ...
              <React.Fragment key={item.id}>
                {showQuote1 && (
                  <div className="masonry-item animate-card" style={{
                    padding: "36px 32px",
                    background: "linear-gradient(135deg, rgba(229, 192, 123,0.06) 0%, rgba(6,182,212,0.03) 100%)",
                    ...
                    <span style={{ fontSize: "2rem", color: "#E5C07B", fontFamily: "Georgia, serif", lineHeight: 0.1, alignSelf: "flex-start" }}>“</span>
                ...
                {showQuote2 && (
                  <div className="masonry-item animate-card" style={{
                    padding: "36px 32px",
                    background: "linear-gradient(135deg, rgba(6,182,212,0.06) 0%, rgba(229, 192, 123,0.03) 100%)",
                    ...
                    <span style={{ fontSize: "0.68rem", color: "#E5C07B", textTransform: "uppercase", letterSpacing: "0.15em", fontWeight: "600", fontFamily: "monospace" }}>
                      — Rhea M., DJ & Producer
                    </span>
                  </div>
                )}
                ...
                <motion.div onClick={() => setLightbox(item)}
                  ...
                  whileHover={{ scale: 1.02, borderColor: "rgba(229, 192, 123,0.3)" }}
                >
        ...
        {lightbox && (
          <motion.div onClick={() => setLightbox(null)} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.6, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.6, opacity: 0 }}
              ...
              style={{ background: "#0d0d0d", border: "1px solid rgba(229, 192, 123,0.3)", borderRadius: 24, overflow: "hidden", boxShadow: "0 0 120px rgba(229, 192, 123,0.18)", maxWidth: "90vw", maxHeight: "85vh" }}>
    ...
    <section id="about" style={{ background: "transparent", padding: "clamp(140px, 15vw, 220px) 5vw", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}
            ...
            <div>
              <motion.h2
                ...
                SOUND.<br />
                <span style={{ color: "#E5C07B" }}>STILLNESS.</span><br />
                COMMUNITY.
              </motion.h2>
            ...
            {founders.map((f, i) => (
              <motion.div
                ...
                <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "32px 28px", zIndex: 2 }}>
                  <div style={{ fontSize: "0.72rem", color: "#E5C07B", letterSpacing: "0.2em", textTransform: "uppercase", fontWeight: "700", marginBottom: 6 }}>
                    {f.role.toUpperCase()}
                  </div>
                  <h3 style={{
                    fontFamily: "'Bebas Neue', sans-serif",
        ...
        <motion.div
          ...
          whileHover={{ borderColor: "rgba(229, 192, 123, 0.25)", boxShadow: "0 30px 70px rgba(0,0,0,0.65), 0 0 30px rgba(229, 192, 123, 0.05)" }}
          style={{
            maxWidth: 950,
            margin: "96px auto 0",
            textAlign: "center",
        ...
        >
          ...
          <div style={{ marginTop: 24, fontSize: "0.82rem", letterSpacing: "0.25em", color: "#E5C07B", textTransform: "uppercase", fontWeight: "600", fontFamily: "monospace" }}>
            — Arjuna & Deepa
          </div>
        </motion.div>
      </div>
...
function Contact({ toast }) {
    ...
    const inp = field => ({
      ...
      border: `1px solid ${errors[field] ? "#ef4444" : "rgba(229, 192, 123,0.2)"}`,
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 48, marginTop: 60, maxWidth: 900, margin: "60px auto 0" }}>
            ...
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
              ...
              {[["Location", "Bansilal Stepwell", "Hyderabad, Telangana, India"], ["Contact", "hello@tangysessions.in", ""]].map(([title, line1, line2]) => (
                <div key={title} style={{ marginBottom: 24 }}>
                  <div style={{ color: "#E5C07B", fontSize: "0.72rem", letterSpacing: "0.25em", textTransform: "uppercase", fontFamily: "monospace", marginBottom: 8, fontWeight: "600" }}>{title}</div>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 24 }}>
                {["Instagram", "Spotify", "SoundCloud"].map(s => (
                  <motion.button key={s} onClick={() => toast({ message: `Opening ${s}...`, type: "info" })}
                    whileHover={{ scale: 1.05, borderColor: "#E5C07B", color: "#E5C07B" }} whileTap={{ scale: 0.95 }}
              ...
              <div style={{ borderRadius: 10, overflow: "hidden", border: "1px solid rgba(229, 192, 123,0.2)", height: 200 }}>
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
              style={{
                background: "linear-gradient(135deg, rgba(8,8,12,0.7) 0%, rgba(8,8,12,0.45) 100%)",
                backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)",
                border: isFormFocused ? "1px solid rgba(229, 192, 123,0.45)" : "1px solid rgba(255,255,255,0.08)",
                borderRadius: 16, padding: "32px",
                boxShadow: isFormFocused
                  ? "0 24px 60px rgba(0,0,0,0.85), 0 0 30px rgba(229, 192, 123,0.18), inset 0 1px 0 rgba(255,255,255,0.1)"
                  ...
                  <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                    {["name", "email"].map(f => (
                      <div key={f} style={{ marginBottom: 14 }}>
                        <input placeholder={f.charAt(0).toUpperCase() + f.slice(1)} value={form[f]}
                          ...
                          style={inp(f)}
                          onFocus={e => { setIsFormFocused(true); e.target.style.borderColor = "#E5C07B"; e.target.style.background = "rgba(229, 192, 123,0.06)"; e.target.style.boxShadow = "0 0 0 3px rgba(229, 192, 123,0.12)"; }}
                          onBlur={e => { setIsFormFocused(false); e.target.style.borderColor = errors[f] ? "#ef4444" : "rgba(229, 192, 123,0.2)"; e.target.style.background = "rgba(0,0,0,0.55)"; e.target.style.boxShadow = "none"; }}
                        />
                    ...
                    <div style={{ marginBottom: 14 }}>
                      <textarea placeholder="Your message (optional if subscribing to Tangy Letter)" value={form.message} rows={4}
                        ...
                        onFocus={e => { setIsFormFocused(true); e.target.style.borderColor = "#E5C07B"; e.target.style.background = "rgba(229, 192, 123,0.06)"; e.target.style.boxShadow = "0 0 0 3px rgba(229, 192, 123,0.12)"; }}
                        onBlur={e => { setIsFormFocused(false); e.target.style.borderColor = errors.message ? "#ef4444" : "rgba(229, 192, 123,0.2)"; e.target.style.background = "rgba(0,0,0,0.55)"; e.target.style.boxShadow = "none"; }}
                      />
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20, cursor: "pointer", userSelect: "none" }}
                      ...
                      <input type="checkbox" checked={form.subscribe} onChange={() => {}} 
                        style={{ width: 16, height: 16, cursor: "pointer", accentColor: "#E5C07B" }} />
                    ...
                    <MagneticButton onClick={handleSend}
                      style={{ width: "100%", padding: 15, background: "#E5C07B", color: "#fff", border: "none", borderRadius: 8, cursor: "pointer", fontFamily: "inherit", letterSpacing: "0.1em", textTransform: "uppercase", fontSize: "0.85rem", fontWeight: 700, boxShadow: "0 0 20px rgba(229, 192, 123,0.25)" }}>
...
function Footer() {
  return (
    <footer style={{
        ...
        borderTop: "1px solid rgba(229, 192, 123,0.18)",
      ...
      <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 40, marginBottom: 48 }}>
        ...
        <div style={{ display: "flex", gap: 60, flexWrap: "wrap" }}>
          {[["Explore", ["Events", "Artists", "Gallery"]], ["Connect", ["Instagram", "Spotify", "Contact"]]].map(([title, items]) => (
            <div key={title}>
              <div style={{ color: "#E5C07B", fontSize: "0.68rem", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 16 }}>{title}</div>
              {items.map(item => (
...
function SectionHeader({ label, title }) {
  return (
    <motion.div initial={{ opacity: 0, y: -16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} style={{ textAlign: "center" }}>
      <div style={{ fontSize: "0.68rem", letterSpacing: "0.38em", color: "#E5C07B", textTransform: "uppercase", fontFamily: "monospace", marginBottom: 14 }}>{label}</div>
      ...
      <motion.div initial={{ width: 0 }} whileInView={{ width: 48 }} transition={{ duration: 0.8, delay: 0.2 }} viewport={{ once: true }}
        style={{ height: 2, background: "linear-gradient(to right, #E5C07B, #06b6d4)", margin: "18px auto 0", borderRadius: 2 }} />
    </motion.div>
  );
}
...
function LandingPage({ showArtistOverlay = false }) {
  ...
  return (
    <div style={{ background: "transparent", minHeight: "100vh", fontFamily: "'DM Sans', system-ui, sans-serif", color: "#fff", position: "relative" }}>
      ...
      <div style={{ width: "100%", height: "1px", background: "linear-gradient(to right, transparent, rgba(229, 192, 123,0.12) 50%, transparent)", margin: "0 auto" }} />
