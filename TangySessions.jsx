...
function Navbar() {
  ...
  return (
    <nav style={{
      ...
      borderBottom: scrolled ? "1px solid rgba(229, 192, 123,0.2)" : "none",
  ...
  return (
    <motion.div
      ...
      whileHover={{ 
        ...
        rotateY: 5, 
        rotateX: -5,
        boxShadow: "0 25px 60px rgba(229, 192, 123,0.25)",
        ...
        {lightbox && (
          <motion.div onClick={() => setLightbox(null)} 
            ...
            <motion.div 
              ...
              style={{
                background: "#111", border: "1px solid rgba(229, 192, 123,0.3)", borderRadius: "16px",
                padding: "60px 80px", textAlign: "center",
                boxShadow: "0 0 100px rgba(229, 192, 123,0.2)"
              }}>
  ...
  return (
    <motion.div
      ...
      whileHover={{ 
        ...
        boxShadow: "0 25px 50px rgba(229, 192, 123,0.25)"
      }}
      style={{
  ...
  return (
    <section id="tickets" style={{ background: "transparent", padding: "100px 5vw", perspective: "1000px" }}>
      ...
      <motion.div 
        ...
        whileHover={{ boxShadow: "0 40px 80px rgba(229, 192, 123,0.15)" }}
        style={{ maxWidth: "520px", margin: "60px auto 0", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(229, 192, 123,0.2)", borderRadius: "16px", padding: "40px", transformStyle: "preserve-3d" }}>
        ...
        <motion.div 
          whileHover={{ translateY: -5, boxShadow: "0 10px 30px rgba(229, 192, 123,0.15)" }}
          style={{ background: "rgba(229, 192, 123,0.08)", border: "1px solid rgba(229, 192, 123,0.2)", borderRadius: "10px", padding: "20px", marginBottom: "28px", transform: "translateZ(30px)" }}>
    ...
    <section id="contact" style={{ background: "transparent", padding: "100px 5vw", perspective: "1000px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "60px", marginTop: "60px", maxWidth: "1000px", margin: "60px auto 0" }}>
        ...
        <motion.div 
          ...
          <motion.div 
            whileHover={{ boxShadow: "0 20px 40px rgba(229, 192, 123,0.25)", borderColor: "rgba(229, 192, 123,0.4)" }}
            style={{ marginTop: "32px", borderRadius: "10px", overflow: "hidden", border: "1px solid rgba(229, 192, 123,0.2)", height: "220px", transform: "translateZ(40px)", position: "relative" }}>
            <iframe
...
function Footer() {
  return (
    <footer style={{ background: "transparent", borderTop: "1px solid rgba(229, 192, 123,0.15)", padding: "60px 5vw 32px" }}>
