  ...
  <style>{`
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    :root {
      ...
      --tangy-border:   rgba(212, 175, 55,0.22);
      --tangy-amber:    #D4AF37;
      --tangy-amber-dim:#B8860B;
      --tangy-rust:     #06b6d4;
      --tangy-cream:    #ffffff;
      --tangy-muted:    rgba(255,255,255,0.65);
      --tangy-glow:     rgba(212, 175, 55,0.2);
      --glass-bg:       linear-gradient(135deg, rgba(8,8,12,0.82) 0%, rgba(8,8,12,0.62) 100%);
      --glass-border:   rgba(212, 175, 55,0.28);
      --glass-blur:     24px;
      --glass-shadow:   0 20px 40px rgba(0,0,0,0.7), 0 0 30px rgba(212, 175, 55,0.12), inset 0 1px 1px rgba(255,255,255,0.05);
    }
    ...
    .t-card {
      ...
      box-shadow: 0 16px 32px rgba(0,0,0,0.6), 0 0 20px rgba(212, 175, 55,0.08), inset 0 1px 0 rgba(255,255,255,0.04);
      border-radius: 12px;
      transition: box-shadow 0.3s, border-color 0.3s;
    }
    .t-card:hover {
      border-color: rgba(212, 175, 55,0.38);
      box-shadow: 0 20px 40px rgba(0,0,0,0.7), 0 0 30px rgba(212, 175, 55,0.18), inset 0 1px 0 rgba(255,255,255,0.06);
    }
    ...
    .t-input:focus {
      ...
      box-shadow: 0 0 0 3px rgba(212, 175, 55,0.12), 0 0 16px rgba(212, 175, 55,0.1);
    }
    ...
    .t-btn-primary:hover { background: #FFD700; transform: translateY(-1px); box-shadow: 0 8px 32px rgba(212, 175, 55,0.3); }
    ...
    .t-btn-ghost:hover { border-color: var(--tangy-amber); color: var(--tangy-amber); background: rgba(212, 175, 55,0.05); }
    ...
    .cal-cell:hover { border-color: rgba(212, 175, 55,0.3); background: rgba(212, 175, 55,0.06); }
...
const AmbientBg = ({ variant = 'default' }) => {
  const configs = {
    default: { c1: '#D4AF37', c2: '#06b6d4', c3: '#1a0f2e' },
        ...
        <div className="glass" style={{
          ...
          {notifs.map(n => (
            <div key={n.id} onClick={() => { setShow(false); setPage('dashboard'); modal.toast({ message: `Navigating to: ${n.title}` }); }} style={{
              ...
              background: n.unread ? 'rgba(212, 175, 55,0.06)' : 'transparent',
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hov
          ? '0 24px 60px rgba(0,0,0,0.75), 0 0 40px rgba(212, 175, 55,0.18), inset 0 1px 0 rgba(255,255,255,0.06)'
          : '0 12px 32px rgba(0,0,0,0.6), 0 0 20px rgba(212, 175, 55,0.06), inset 0 1px 0 rgba(255,255,255,0.03)',
      }}
    >
      {/* Image area */}
        ...
        <div className="glass" style={{ borderRadius: 12, padding: '2.5rem' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '1.5rem' }}>
                {genres.map(g => (
                  <button key={g} onClick={() => toggleGenre(g)} style={{
                    ...
                    background: form.genre.includes(g) ? 'rgba(212, 175, 55,0.15)' : 'transparent',
          ...
          {step === 4 && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div style={{ border: '2px dashed rgba(255,255,255,0.1)', borderRadius: 8, padding: '2rem', textAlign: 'center', cursor: 'pointer', transition: 'border-color 0.2s' }} onMouseEnter={e => e.target.style.borderColor = 'rgba(212, 175, 55,0.3)'} onMouseLeave={e => e.target.style.borderColor = 'rgba(255,255,255,0.1)'}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
          {genres.map(g => (
            <button key={g} onClick={() => setFilter(g)} style={{
              ...
              background: filter === g ? 'rgba(212, 175, 55,0.12)' : 'transparent',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '2rem', alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                ...
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem 0', borderBottom: i < upcomingShows.length - 1 ? '1px solid var(--tangy-border)' : 'none', gap: '1rem', flexWrap: 'wrap' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    ...
                    <span style={{
                      ...
                      background: s.status === 'confirmed' ? 'rgba(74,222,128,0.12)' : 'rgba(212, 175, 55,0.12)',
                      color: s.status === 'confirmed' ? '#4ade80' : 'var(--tangy-amber)',
                      border: `1px solid ${s.status === 'confirmed' ? 'rgba(74,222,128,0.3)' : 'rgba(212, 175, 55,0.3)'}`,
                    }}>{s.status}</span>
                  </div>
                </div>
              ))}
            ...
            <div className="glass" style={{ borderRadius: 10, padding: '1.8rem', animation: 'fadeUp 0.6s 0.4s ease both' }}>
              ...
              {invites.map((inv, i) => (
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.2rem', background: 'rgba(212, 175, 55,0.05)', borderRadius: 8, border: '1px solid rgba(212, 175, 55,0.15)', flexWrap: 'wrap', gap: '1rem' }}>
                  <div>
            ...
            <div className="glass" style={{ borderRadius: 10, padding: '1.5rem', animation: 'fadeUp 0.6s 0.35s ease both' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                {quickActions.map((qa, i) => (
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(212, 175, 55,0.3)'; e.currentTarget.style.background = 'rgba(212, 175, 55,0.05)'; e.currentTarget.style.color = 'var(--tangy-cream)'; }}
            ...
            <div className="glass" style={{ borderRadius: 10, padding: '1.5rem', animation: 'fadeUp 0.6s 0.55s ease both' }}>
              ...
              {[
                ...
                <div key={i} style={{ padding: '0.6rem 0', borderBottom: i < 2 ? '1px solid rgba(255,255,255,0.04)' : 'none' }}>
                  ...
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '0.58rem', color: 'rgba(212, 175, 55,0.5)' }}>{a.time}</p>
                </div>
              ))}
            </div>
          </div>
...
const CalendarPage = () => {
  ...
  const bgForStatus = s => ({
    ...
    tentative: 'rgba(212, 175, 55,0.15)',
              ...
              {Array.from({ length: daysInMonth }, (_, i) => i + 1).map(day => {
                ...
                return (
                  <div
                    ...
                    onMouseEnter={e => { if (!status) e.currentTarget.style.background = 'rgba(212, 175, 55,0.06)'; }}
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '3rem 2rem', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '2rem', marginBottom: '3rem', flexWrap: 'wrap' }}>
          <div style={{
            ...
            boxShadow: '0 0 40px rgba(212, 175, 55,0.3)', cursor: 'pointer', position: 'relative', overflow: 'hidden'
        ...
        {tab === 'media' && (
          <div className="glass" style={{ borderRadius: 12, padding: '2rem' }}>
            ...
            <div style={{ border: '2px dashed rgba(212, 175, 55,0.2)', borderRadius: 10, padding: '3rem', textAlign: 'center', marginBottom: '1.5rem', cursor: 'pointer' }}>
